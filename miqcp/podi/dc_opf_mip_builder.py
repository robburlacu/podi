...
REFERENCE_ANGLE_CONSTRAINT_NAME = 'reference_angle'    #fixed angle
PHASE_ANGLE_DIFFERENCE_EQUATION_CONSTRAINT_NAME = 'angle_difference_equation'    #angle difference
...
def build_thermal_limit(constraint_name, from_bus_id, to_bus_id, minlp, network, number=''):
    if number=='':
        ...
        variables = [minlp.variables[REAL_FLOW_VARIABLE_NAME][from_bus_id ,to_bus_id,number]]
